...
public class BlueprintsScoringApp {
    ...
    public static void main(String[] args) {
        ...
        // Let's build the building in Example 1 of the instructions: https://docs.google.com/document/d/1ykYYsKKss8MeMSR5h-xMEtfcuIlTbhLjMmkZiibyJ8E/edit?tab=t.0#bookmark=id.9vx6xcscvpkr
        ...
        firstRow.add("--");
        firstRow.add("R6");
        building.add(firstRow);

        ArrayList<String> secondRow = new ArrayList<>();
        secondRow.add("--");
        secondRow.add("R3");
        secondRow.add("S6");
        building.add(secondRow);

        ArrayList<String> thirdRow = new ArrayList<>();
        thirdRow.add("G4");
        thirdRow.add("W2");
        thirdRow.add("S5");
        building.add(thirdRow);
        
        int result = app.getGlassScore(building);

        System.out.println("Result is: " + result); // We expect this to return 4.
